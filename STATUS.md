...
Deletes itself at `2.0.0`. Last refreshed: 2026-05-15 (Phase 0 audit).
...
| Feature | Issue | Status | Notes |
|---|---|---|---|
| `.dump()` coverage | #18 | ⚠️ partial | dict, list, queue, blob, log have it. **docs (collections), vectors, channels, sketches, graphs, events** do not. |
| `.load()` coverage | #18 | ❌ none | Not implemented anywhere. Phase 1 work. |
| YAML / JSONL streaming dump+load | #18 | ❌ none | JSON-only. Phase 1 work. |
