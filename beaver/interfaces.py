...
@runtime_checkable
class IDictBatch[T: BaseModel](Protocol):
    def set(self, key: str, value: T, ttl_seconds: float | None = None) -> None: ...
    def __setitem__(self, key: str, value: T) -> None: ...
    async def __aenter__(self) -> "IDictBatch[T]": ...
    async def __aexit__(self, exc_type, exc_val, exc_tb) -> None: ...


@runtime_checkable
class IListBatch[T: BaseModel](Protocol):
    def push(self, value: T) -> None: ...
    def prepend(self, value: T) -> None: ...
    async def __aenter__(self) -> "IListBatch[T]": ...
    async def __aexit__(self, exc_type, exc_val, exc_tb) -> None: ...


@runtime_checkable
class ILogBatch[T: BaseModel](Protocol):
    def log(self, data: T, timestamp: float | None = None) -> None: ...
    async def __aenter__(self) -> "ILogBatch[T]": ...
    async def __aexit__(self, exc_type, exc_val, exc_tb) -> None: ...


@runtime_checkable
class IBlobBatch[T: BaseModel](Protocol):
    def put(self, key: str, data: bytes, metadata: dict | None = None) -> None: ...
    async def __aenter__(self) -> "IBlobBatch[T]": ...
    async def __aexit__(self, exc_type, exc_val, exc_tb) -> None: ...


@runtime_checkable
class IDocumentsBatch[T: BaseModel](Protocol):
    def index(
        self,
    ...
    async def __aenter__(self) -> "IDocumentsBatch[T]": ...
    async def __aexit__(self, exc_type, exc_val, exc_tb) -> None: ...
...
class IAsyncBeaverDocuments[T: BaseModel](Protocol):
    ...
    def batched(self) -> "IDocumentsBatch[T]": ...
