...
def expose(path: str, method: str, cli_name: str, cli_help: str, body_param: str | None = None):
    ...
    """
    meta = EndpointMeta(path=path, method=method, cli_name=cli_name, cli_help=cli_help, body_param=body_param)
